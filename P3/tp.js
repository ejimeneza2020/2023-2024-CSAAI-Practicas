...
var canasta3 = document.getElementById("canasta3");
var canasta3 = document.getElementById("canasta3");
...
pelota1.onload = ()=> {
  ...
  //-- ya esté cargada!
  ctx.drawImage(pelota1, xop, canvas.height-yop);
};

canasta3.onload = ()=> {
  //-- Insertar la imagen en el canvas, una vez que
  //-- ya esté cargada!
  ctx.drawImage(canasta3, xo-25,yo-25);
};

//-- Dibujar el objetivo
dibujarO(xo, yo, canasta3); // Pintar el objetivo
